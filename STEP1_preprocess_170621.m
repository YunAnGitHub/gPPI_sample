...
% 2017-Jun-21 Yun-An Huang
% change the subject number to 12 

% 2016-Dec-20 Yun-An Huang
% use the preprocess method of SPM12
% slice timing, realign, coregister, segment, normalize, smooth

% 2016-Dec-09 Yun-An Huang
% to analyze the data of healthy subject with gPPI matrix
% 
% 
...
smooth_kernel = [6 6 6];
%outpath
outpath = 'z_group_PPI/data_61ROI';
if exist(outpath)
    for jtemp = 1:ROI_num
